  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <button className=" hover:cursor-pointer group relative dark:bg-neutral-800 bg-neutral-200  p-px overflow-hidden">
          ...
          <span className="flex items-center justify-center gap-1 relative z-[1] dark:bg-neutral-950/90 bg-neutral-50/90  py-2 px-4 pl-2 w-full">
            <span className="relative group-hover:scale-105 transition-transform group-hover:rotate-[360deg] duration-500">
              ...
              <span
                className=" size-11 absolute opacity-0 dark:opacity-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 blur-lg"
                style={{
                  animation:
