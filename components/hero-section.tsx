  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        ...
        <Image src='/images/dark.png' alt="test" width={100} height={100}/>
            ...
            <div className="mx-auto max-w-5xl px-6">
              <div className="sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  ...
                  everything in one place. Fast, simple, and accessible anywhere.
                </TextEffect>
            ...
            >
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-5xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                  <Image
                    className="bg-background aspect-15/8 relative hidden rounded-2xl dark:block object-cover object-left"
                    src="/images/dark.png"
                    alt="app screen"
                    width={2700}
                    height={1440}
