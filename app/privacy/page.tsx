    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc pl-5 mb-4">
        ...
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to Rivorea Notes.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Rivorea Notes, accessible from{" "}
      ...
      <p className="mb-4">
        ...
        in to Your Account, if you have one, and visiting the settings section
      ...
      <ul className="list-disc pl-5 mb-4">
        <li>By email: support@rivoreanotes.com</li>
      </ul>
    </div>
  );
};
